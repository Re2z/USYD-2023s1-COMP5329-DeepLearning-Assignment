...
class MLP:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            train_pre = nn1.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn1.predict(X_val)
    ...
    def predict(self, x):
        ...
        output = nn1.forward(x[:, :], test_flg=True)
        # Softmax progress
...
class MLP2:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            # Predict the accuracy of the training and validation data for one epoch
            train_pre = nn3.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn3.predict(X_val)
            val_acc = accuracy_score(y_val, val_pre)
    ...
    def predict(self, x):
        ...
        pred = np.zeros(x.shape[0])
        # Put all data to the forward progress
        output = nn3.forward(x[:, :], test_flg=True)
        # Softmax progress
        exps = np.exp(output - np.max(output, axis=1, keepdims=True))
        output = exps / np.sum(exps, axis=1, keepdims=True)
        # Select the max one as the label
...
class MLP3:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            # Predict the accuracy of the training and validation data for one epoch
            train_pre = nn5.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn5.predict(X_val)
            val_acc = accuracy_score(y_val, val_pre)
    ...
    def predict(self, x):
        ...
        pred = np.zeros(x.shape[0])
        # Put all data to the forward progress
        output = nn5.forward(x[:, :], test_flg=True)
        # Softmax progress
        exps = np.exp(output - np.max(output, axis=1, keepdims=True))
        output = exps / np.sum(exps, axis=1, keepdims=True)
        # Select the max one as the label
...
nn5 = MLP3([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_5, train_acc_5, validata_acc_5 = nn5.fit(X_train, y_train, learning_rate=0.001, epochs=100, mini_batch_size=64,
                                             optimizer="momentum", weight_decay_lambda=0.001, momentum=0.9, rho1=0.9,
                                             rho2=0.999, dropout_rate=0.5)

nn3 = MLP2([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_3, train_acc_3, validata_acc_3 = nn3.fit(X_train, y_train, learning_rate=0.001, epochs=100, mini_batch_size=64,
                                             optimizer="momentum", weight_decay_lambda=0.001, momentum=0.9, rho1=0.9,
                                             rho2=0.999, dropout_rate=0.3)

nn1 = MLP([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_1, train_acc_1, validata_acc_1 = nn1.fit(X_train, y_train, learning_rate=0.001, epochs=100, mini_batch_size=64,
                                             optimizer="momentum", weight_decay_lambda=0.001, momentum=0.9, rho1=0.9,
                                             rho2=0.999, dropout_rate=0.1)

# Plot the loss figure
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.plot(loss_1, label='dropout_rate_0.1')
plt.plot(loss_3, label='dropout_rate_0.3')
plt.plot(loss_5, label='dropout_rate_0.5')
plt.legend()
plt.show()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.plot(train_acc_1, label='train_acc_dropout_0.1')
plt.plot(validata_acc_1, label='val_acc_dropout_0.1')
plt.plot(train_acc_3, label='train_acc_dropout_0.3')
plt.plot(validata_acc_3, label='val_acc_dropout_0.3')
plt.plot(train_acc_5, label='train_acc_dropout_0.5')
plt.plot(validata_acc_5, label='val_acc_dropout_0.5')
plt.legend()
plt.show()

# Calculate the accuracy of the test dataset
_pre_1 = nn1.predict(X_test)
...
print('Test-accuracy-0.1: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_1, f1_1, recall_1,
                                                                                                  precision_1))
# Calculate the accuracy of the test dataset
_pre_3 = nn3.predict(X_test)
...
print('Test-accuracy-0.3: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_3, f1_3, recall_3,
                                                                                                  precision_3))
# Calculate the accuracy of the test dataset
_pre_5 = nn5.predict(X_test)
...
print('Test-accuracy-0.5: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_3, f1_3, recall_3,
                                                                                                  precision_3))
