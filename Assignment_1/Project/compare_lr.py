...
class MLP:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            train_pre = nn01.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn01.predict(X_val)
    ...
    def predict(self, x):
        ...
        output = nn01.forward(x[:, :], test_flg=True)
        # Softmax progress
...
class MLP2:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            # Predict the accuracy of the training and validation data for one epoch
            train_pre = nn001.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn001.predict(X_val)
            val_acc = accuracy_score(y_val, val_pre)
    ...
    def predict(self, x):
        ...
        pred = np.zeros(x.shape[0])
        # Put all data to the forward progress
        output = nn001.forward(x[:, :], test_flg=True)
        # Softmax progress
        exps = np.exp(output - np.max(output, axis=1, keepdims=True))
        output = exps / np.sum(exps, axis=1, keepdims=True)
        # Select the max one as the label
...
class MLP3:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            # Predict the accuracy of the training and validation data for one epoch
            train_pre = nn0001.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn0001.predict(X_val)
            val_acc = accuracy_score(y_val, val_pre)
    ...
    def predict(self, x):
        ...
        pred = np.zeros(x.shape[0])
        # Put all data to the forward progress
        output = nn0001.forward(x[:, :], test_flg=True)
        # Softmax progress
        exps = np.exp(output - np.max(output, axis=1, keepdims=True))
        output = exps / np.sum(exps, axis=1, keepdims=True)
        # Select the max one as the label
...
nn01 = MLP([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_01, train_acc_01, validata_acc_01 = nn01.fit(X_train, y_train,
...
nn001 = MLP2([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_001, train_acc_001, validata_acc_001 = nn001.fit(X_train, y_train,
...
nn0001 = MLP3([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_0001, train_acc_0001, validata_acc_0001 = nn0001.fit(X_train, y_train, learning_rate=0.001, epochs=200,
                                                      mini_batch_size=64,
                                                      optimizer="momentum", weight_decay_lambda=0.001, momentum=0.9,
                                                      rho1=0.9,
                                                      rho2=0.999, dropout_rate=0.4)
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.plot(loss_01, label='loss_lr0.1')
plt.plot(loss_001, label='loss__lr0.01')
plt.plot(loss_0001, label='loss__lr0.001')
plt.legend()
plt.show()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.plot(train_acc_01, label='train_acc_lr0.1')
plt.plot(validata_acc_01, label='val_acc_lr0.1')
plt.plot(train_acc_001, label='train_acc_lr0.01')
plt.plot(validata_acc_001, label='val_acc_lr0.01')
plt.plot(train_acc_0001, label='train_acc_lr0.001')
plt.plot(validata_acc_0001, label='val_acc_lr0.001')
plt.legend()
plt.show()

# Calculate the accuracy of the test dataset
_pre_01 = nn01.predict(X_test)
acc_01 = accuracy_score(y_test, _pre_01)
f1_01 = f1_score(y_test, _pre_01, average='macro')
recall_01 = recall_score(y_test, _pre_01, average='macro')
precision_01 = precision_score(y_test, _pre_01, average='macro')
print('Test-accuracy-0.1: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_01, f1_01, recall_01,
                                                                                              precision_01))
# Calculate the accuracy of the test dataset
_pre_001 = nn001.predict(X_test)
acc_001 = accuracy_score(y_test, _pre_001)
f1_001 = f1_score(y_test, _pre_001, average='macro')
recall_001 = recall_score(y_test, _pre_001, average='macro')
precision_001 = precision_score(y_test, _pre_001, average='macro')
print(
    'Test-accuracy-0.01: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_001, f1_001, recall_001,
                                                                                            precision_001))
# Calculate the accuracy of the test dataset
_pre_0001 = nn0001.predict(X_test)
acc_0001 = accuracy_score(y_test, _pre_0001)
f1_0001 = f1_score(y_test, _pre_0001, average='macro')
recall_0001 = recall_score(y_test, _pre_0001, average='macro')
precision_0001 = precision_score(y_test, _pre_0001, average='macro')
print('Test-accuracy-0.001: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_0001, f1_0001, recall_0001,
                                                                                              precision_0001))
