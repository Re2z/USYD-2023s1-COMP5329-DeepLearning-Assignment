...
class MLP:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            train_pre = nn_None.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn_None.predict(X_val)
    ...
    def predict(self, x):
        ...
        output = nn_None.forward(x[:, :], test_flg=True)
        # Softmax progress
...
class MLP2:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            # Predict the accuracy of the training and validation data for one epoch
            train_pre = nn_mom.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn_mom.predict(X_val)
            val_acc = accuracy_score(y_val, val_pre)
    ...
    def predict(self, x):
        ...
        pred = np.zeros(x.shape[0])
        # Put all data to the forward progress
        output = nn_mom.forward(x[:, :], test_flg=True)
        # Softmax progress
        exps = np.exp(output - np.max(output, axis=1, keepdims=True))
        output = exps / np.sum(exps, axis=1, keepdims=True)
        # Select the max one as the label
...
class MLP3:
    ...
    def fit(self, X, y, learning_rate=0.1, epochs=100, mini_batch_size=128, optimizer=None, weight_decay_lambda=1,
        ...
        for k in range(epochs):
            ...
            # Predict the accuracy of the training and validation data for one epoch
            train_pre = nn_ada.predict(X_train)
            train_acc = accuracy_score(y_train, train_pre)
            val_pre = nn_ada.predict(X_val)
            val_acc = accuracy_score(y_val, val_pre)
    ...
    def predict(self, x):
        ...
        pred = np.zeros(x.shape[0])
        # Put all data to the forward progress
        output = nn_ada.forward(x[:, :], test_flg=True)
        # Softmax progress
        exps = np.exp(output - np.max(output, axis=1, keepdims=True))
        output = exps / np.sum(exps, axis=1, keepdims=True)
        # Select the max one as the label
...
nn_None = MLP([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_None, train_acc_None, validata_acc_None = nn_None.fit(X_train, y_train, learning_rate=0.001, epochs=100, mini_batch_size=64,
                                             optimizer=None, weight_decay_lambda=0.001, momentum=0.9, rho1=0.9,
                                             rho2=0.999, dropout_rate=0.4)

nn_mom = MLP2([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_mom, train_acc_mom, validata_acc_mom = nn_mom.fit(X_train, y_train, learning_rate=0.001, epochs=100, mini_batch_size=64,
                                             optimizer="momentum", weight_decay_lambda=0.001, momentum=0.9, rho1=0.9,
                                             rho2=0.999, dropout_rate=0.4)

nn_ada = MLP3([128, 1280, 640, 320, 120, 32, 10], [None, 'relu', 'relu', 'relu', 'relu', 'relu', 'relu'], dropout=True,
         batch_norm=True)
loss_ada, train_acc_ada, validata_acc_ada = nn_ada.fit(X_train, y_train, learning_rate=0.001, epochs=100, mini_batch_size=64,
                                             optimizer="adam", weight_decay_lambda=0.001, momentum=0.9, rho1=0.9,
                                             rho2=0.999, dropout_rate=0.4)
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.plot(train_acc_None, label='train_acc_None')
plt.plot(validata_acc_None, label='val_acc_None')
plt.plot(train_acc_mom, label='train_acc_momentum')
plt.plot(validata_acc_mom, label='val_acc_momentum')
plt.plot(train_acc_ada, label='train_acc_Adam')
plt.plot(validata_acc_ada, label='val_acc_Adam')
plt.legend()
plt.show()

# Calculate the accuracy of the test dataset
_pre_1 = nn_None.predict(X_test)
acc_1 = accuracy_score(y_test, _pre_1)
f1_1 = f1_score(y_test, _pre_1, average='macro')
recall_1 = recall_score(y_test, _pre_1, average='macro')
precision_1 = precision_score(y_test, _pre_1, average='macro')
print('Test-accuracy-None: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_1, f1_1, recall_1,
                                                                                                  precision_1))
# Calculate the accuracy of the test dataset
_pre_3 = nn_mom.predict(X_test)
acc_3 = accuracy_score(y_test, _pre_3)
f1_3 = f1_score(y_test, _pre_3, average='macro')
recall_3 = recall_score(y_test, _pre_3, average='macro')
precision_3 = precision_score(y_test, _pre_3, average='macro')
print('Test-accuracy-mom: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_3, f1_3, recall_3,
                                                                                                  precision_3))
# Calculate the accuracy of the test dataset
_pre_5 = nn_ada.predict(X_test)
acc_5 = accuracy_score(y_test, _pre_5)
f1_5 = f1_score(y_test, _pre_5, average='macro')
recall_5 = recall_score(y_test, _pre_5, average='macro')
precision_5 = precision_score(y_test, _pre_5, average='macro')
print('Test-accuracy-adam: {0:.4f}, F1_score: {1:.4f}, Recall: {2:.4f}, Precision: {3:.4f}'.format(acc_5, f1_5, recall_5,
                                                                                                  precision_5))
